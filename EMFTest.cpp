...
size_t pdf_Header(FILE *f);
size_t PDF_SelectObject(FILE *f);
...
int main(int argc,const char* argv[])
{
	...
	while(!feof(f))
	{
		...
		switch (code)
		{
		case 1: nRead += pdf_Header(f); break;
		case 37: nRead+= PDF_SelectObject(f); break;
		}
